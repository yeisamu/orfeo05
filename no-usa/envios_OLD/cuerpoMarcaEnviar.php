           ...
           <tr> 
            <td class="grisCCCCCC"> 
              <table width="100%"  border="0"  cellpadding="0" cellspacing="5" class="borde_tab"'>
                <tr class='titulos3' >
                  <th  align="center" width="14%"><img src='<?=$ruta_raiz?>/<?=$imagenes?>/estadoDoc.gif'  border=0 alt="Estado del documento de izquierda a derecha, anexado, radicado, impreso, enviado">
                  </th>
   ...
   while($rs&&!$rs->EOF)
       ...
       if($ki>=$registro and $ki<($registro+20)){
			...
			$edoDev = 0;
				...
				{
				case 99:
				$imgEstado ="<img src='$ruta_raiz/$imagenes/docDevuelto_tiempo.gif'  border=0 alt='Fecha Devolucion :$fecha_dev' title='Fecha Devolucion :$fecha_dev'>";
				break;
				case  98:
				...
				case 97:
					...
					{
						$imgEstado ="<img src='$ruta_raiz/$imagenes/docDevuelto_tiempo.gif'  border=0 alt='Fecha Devolucion :$fecha_dev' title='Devolucion por Tiempo de Espera'>";
				...
				if ($estadoFirma == "NO_SOLICITADA")
					$imgEstado = "<img src=$ruta_raiz/$imagenes/docRadicado.gif  border=0 alt='Este documento ha sido anexado y radicado'>";
				else if ($estadoFirma == "COMPLETA"){
					$imgEstado = "<a  href='javascript:editFirmantes($rad_salida)' > <img src=$ruta_raiz/$imagenes/docFirmado.gif  border=0 alt='Este documento ha sido firmado'></a>"; 
				...
				break;
				case 3:
				$imgEstado = "<img src=$ruta_raiz/$imagenes/docImpreso.gif  border=0 alt='Este documento ha sido anexado, radicado e impreso'>";
				break;
				case 4:
				$imgEstado ="<img src=$ruta_raiz/$imagenes/docEnviado.gif  border=0 alt='Este documento ha sido anexado,radicado, impreso y enviado a su destinatario'>";
				break;
				}
			break;
		}
