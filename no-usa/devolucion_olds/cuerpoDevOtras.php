...
$tbbordes = "#CEDFC6";
$tbfondo = "#FFFFCC";
if(!isset($orno)){$orno=1;}
$imagen="flechadesc.gif";
if (!isset($filtroSelect)) $filtroSelect = ""; if (!isset($tpAnulacion)) $tpAnulacion = ""; if (!isset($ordrTipo)) $orderTipo = "";
if (!isset($orderNo)) $orderNo = "";
 ...
 else
 {
    ...
    if (isset($dependencia_busq)) $dependencia_busq1 .= " $where_fecha and ";
 }
