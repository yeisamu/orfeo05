...
//	echo "<hr>Radicados";
  ...
  $isql = "SELECT a.RADI_NUME_SAL	
	...
	$usua_doc  	 = $rsModEnv->fields["USUA_DOC"];	
...
/* Modificacion Skina                                                                                                           */
/* Se agrega la query_usua_doc debido a que la variable USUA_DOC esta llegando hasta este punto con el valor vacio. Esto genera */
/* un error en el update en la modificaci�n de env�os.					                                        */
/* Johnnatan Rodriguez Pinto                                                                                                    */
/* Mayo 2015                                                                                                                    */
/* jrodriguez@skinatech.com                                                                                                     */
		
	 $query_usua_doc = "SELECT USUA_DOC from sgd_renv_regenvio where RADI_NUME_SAL='$radicados' ";
	 $rs_usua_doc = $db->query($query_usua_doc);
	 $usua_doc = $rs_usua_doc->fields('USUA_DOC');
