<table border=0 width="100%"  cellpad=2 cellspacing='0' class="borde_tab" valign='top' align='center' >
	...
	<input name="busqRadicados" id="busqRadicados" type="text" size="60" class="tex_area" value="<?=$busqRadicados?>" title="Ingrese el numero de radicado completo o una parte de el">
