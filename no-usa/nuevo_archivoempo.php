...
//$swIntegraAps = $_SESSION["swIntegraAps"];
...
<link rel="stylesheet" href=estilos/orfeoaaaa.csss">
...
function escogio_archivo()
{
  ...
  extension = archivo_up.substr(largo,3);
...
?>
		...
		<TD width="68" align="center" class="listado2">&nbsp; <font size=1>
			<a href='nuevo_archivo.php?<?=$variables?>&borrar=<?=$sgd_dir_tipo?>&tpradic=<?=$tpradic?>&aplinteg=<?=$aplinteg?>&numrad=<?=$numrad?>'>Borrar</a></TD>
	</tr>
<?php
		$rs->MoveNext();
	}
