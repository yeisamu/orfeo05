  ...
  <td height="23" class="titulos5">
    <div align="left">
     <label for="nombre"> Nombre</label>
      <input type="text" name="nombre" id="nombre" value="<?php print $_POST['nombre']; ?>" size="40" maxlength="40" align="right" title="Ingrese el nombre del edificio">
    </div>
  </td>
  <td class="titulos5">
    <div align="left">
      <label for="sigla">Sigla</label>
      <input type="text" name="sigla" id="sigla" value="<?php print $_POST['sigla']; ?>" size="4" maxlength="4" align="right" title="Ingrese una abreviación para el nombre del edificio">
    </div>
  </td>
</tr>
<tr>
  <td height="26" class="titulos5">
    <div align="left">
      <label for="numero">Ingrese Número de Tipos de Almacenamiento</label>
      <input type="text" name="numero" id="numero" value="<?php print $_POST['numero']; ?>" size="2" maxlength="2" align="right" title="Ingrese el número de tipos de almacenamiento que tiene el edificio">
    </div>
  </td>
  <td class="titulos5">
    <input type="button" name="btnMostrarCampos" class="botones_2" value="&gt;&gt;" onClick="mostrarCampos();" aria-label="Registrar la información del edificio">
  </td>
</tr>
<tr><td><input name='SALIR' type="button" class="botones" id="envia22" onClick="opener.regresar();window.close();" value="SALIR" align="middle" aria-label="Cerrar esta ventana y volver a administración de edificios"></td></tr>
</table>
</form>
</body>
</html>
