...
<TD class=titulos2 colspan="4">
	...
	<tr>
	<td class="titulos5" align="right"><label for="rad">Radicado:</label></td>
	<td class="titulos5"><input type="text" align="absmiddle" value="<?=$rad?>" id="rad" name="rad" title="Buscar por número de radicado"> </td>
	</tr>
	<tr>
...
<td class='titulos5'>
	...
	<tr><td class='titulos5' align="right" > <label for="tsub">SubSerie</label> </td>
	<td class='titulos5'>
	<?
    ...
    -->
    <tr>
	<td class="titulos5" align="right" ><label for="tdoc">Tipo Documental</label></td>
	<td class="titulos5">
<?
...
?>
	...
	<tr>
	<td class="titulos5" align="right" ><label for="trad">Tipo de Radicado</label></td>
	<td class="titulos5">
<?
...
?>
	<tr>
	<td class="titulos5" align="right"><label for="fechaIni">Fecha Radicado Inicial</label></td>
	<td class="titulos5">
	...
	<tr><td class="titulos5" align="right"><label for="fechaInif">Fecha Radicado Final</label></td>
	<td class="titulos5">
	<script language="javascript">
	...
	<tr>
	<td align="center" colspan="2"><input type="submit" class="botones" value="Buscar" name="Buscar" aria-label="Buscar radicados de acuerdo a los parámetros ingresados" aria-label="Buscar radicados por criterios ingresados">
	<a href='archivo.php?<?=session_name()?>=<?=trim(session_id())?>krd=<?=$krd?>'><input name='Regresar' align="middle" type="button" class="botones" id="envia22" value="Regresar" aria-label="Regresar al menú del módulo de archivo">
	</td>
	</tr>
	</table>
<?
