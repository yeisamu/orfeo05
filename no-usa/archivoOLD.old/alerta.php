...
//  $db->conn->debug=true;
    ...
    print $rsSub->GetMenu2("tsub", $tsub, "0:-- TODAS --", false,"","onChange='submit()' class='select' id='tsub' title='Listado de todas las subseries existentes, se actualiza al seleccionar una serie'" );
