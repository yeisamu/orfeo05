...
<tr>
 <td class="titulos5"><input type="button" name="NUEVO" value="NUEVO EDIFICIO" onClick="NuevoE();" class="botones_funcion" aria-label="Abrir formulario en una nueva ventana para registrar un nuevo edificio">
