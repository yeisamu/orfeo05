...
<TD class=titulos2 align="center" >
	...
	<tr>
<?php if(!isset($phpsession)) $phpsession="";  ?>
	<td class=listado2>
...
<tr>
 <?php if(!isset($dep_sel)) $dep_sel="";  if(!isset($orno)) $orno=""; if(!isset ($tipo_archivo)) $tipo_archivo=""; ?>
  <td class="listado2">
...
<tr>
	<td class=listado2>
<span class="leidos2"><a href='alerta.php?<?=session_name()."=".session_id()."&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="menu_princ"><b>8.Transferencias documentales (Expedientes)</a>	</td>
	</tr>
<tr>
  <td class="listado2">
...
<tr>
  <td class="listado2">
    <span class="leidos2"><a href='<?php print $ruta_raiz; ?>/archivo/adminEdificio.php?<?=session_name()."=".session_id()."&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="menu_princ"><b>11.Administracion de Edificios</a>  </td>
</tr>
<? }?>
<!--
/** Modificacion Skina Ocultar Modulos 		**/
/** Diciembre 2014 		       		**/
