...
if(!isset($orderTipo)) $orderTipo=""; if(!isset($orden_cambio)) $orden_cambio=""; if(!isset($orderNo)) $orderNo="";
if( trim( $orderTipo ) == "" )
{
    $orderTipo="DESC";
}
...
if(!isset($dep_sel)) $dep_sel=""; if(!isset($codigoUsuario)) $codigoUsuario=""; if(!isset($filtroSelect)) $filtroSelect=""; if(!isset($tpAnulacion)) $tpAnulacion=""; if(!isset($tipo_carp)) $tipo_carp=""; if(!isset($chkCarpeta)) $chkCarpeta=""; if(!isset($busqRadicados)) $busqRadicados=""; if(!isset($agendado)) $agendado="";
...
if(!isset($_GET['fechaIniSel'])) $_GET['fechaIniSel'] =""; if(!isset($_GET['fechaInifSel'])) $_GET['fechaInifSel']="";
...
if(!isset($_POST['fechaInif'])) $_POST['fechaInif']="";
