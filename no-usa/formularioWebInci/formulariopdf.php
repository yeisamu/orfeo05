...
//By skina $pdf->Image('../imagenes/PIEDEPAGINA_1.gif',30,275,160,19);
$pdf->Image('../logoEntidadWeb.gif',55,10,100,24);
//By Skina $pdf->Text(110,63,"Entidad Usuario de Orfeo Rad No. ".$_SESSION['radcom']);
...
$pdf->Text(12,87,"Ciudad, ".date('d')." de ".nombremes(date('m'))." de ".date('Y'));
$pdf->Text(12,101,"Senores");
$pdf->SetFont('','B');
$pdf->Text(12,105,"SKINATECH");
$pdf->SetFont('','');
$pdf->Text(12,109,"Ciudad");
$pdf->Text(12,119,"Asunto : ".strtoupper($_SESSION['tipo'])." ".strtoupper($_SESSION['asunto']));
$pdf->SetXY(11,125);
...
// modificado por skinatech febrero 5 de 2010
//$pdf->Output("../bodega/tmp/".$_SESSION['radcom'].".pdf",'F');
$pdf->Output("../bodega/".date('Y')."/".$_SESSION['dependencia']."/".$_SESSION['radcom'].".pdf",'F');
