<?
/************************************************************************
# PROYECTO: Orfeo  MODULO: Email - uploadMail.php  FECHA: Octubre 2012  *
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
#                                                                       *
# Carga un correo electronico para ser radicado                         *
#                                                                       *
#************************************************************************
...
?>
            <img src="imagenes/upload-media.png" w><br>
            <font face="Arial, Helvetica, sans-serif" size="5" color="#003366">
            <font face="Arial, Helvetica, sans-serif" size="2" color="#003366">
        Documento asociado. Si se gener&oacute; algun problema, presione reintentar.</font>                        
                        </td>
            </tr>
        </table>
        <input type="submit" name="uploadFax" value="REINTENTAR" onClick="datos_generales()" class="ebuttons2">
    </td>
    </tr>
</table>
</form>
...
echo "<hr>";
if(!$envioMail) {
    echo "Fall&oacute; el env&iacute;o de correo respuesta $destinatario ";
//    echo "Fall&oacute; el env&iacute;o de correo respuesta $destinatario ->".$envioMail;
}else{
    echo "Se envi&oacute; el correo a $destinatario ";
//    echo "Se envi&oacute; el correo a $destinatario ->".$envioMail;
}
?>
</body>
<center />
