...
<?php
		...
		$isql = "INSERT INTO sgd_dt_radicado (radi_nume_radi, dias_termino)
	            SELECT $rad_salida,0 WHERE NOT EXISTS 
                    (SELECT * FROM sgd_dt_radicado 
...
<p>
<input type="checkBox" name="marcar" checked >  
<input type="submit" class=e_buttons  value="Marcar Impresi&oacute;n">
</p>
</form>
