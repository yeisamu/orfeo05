...
function SetInsDatosTipRad($datos)
{
	...
	$sql = $this->add->AddColumnSQL('DEPENDENCIA',"DEPE_RAD_TP$datos[SGD_TRAD_CODIGO] C(5)");
...
{	
	...
	$sql = "SELECT count(RADI_NUME_RADI) as CNT FROM RADICADO WHERE ".
		$this->cnn->conn->substr."(CAST(RADI_NUME_RADI as char(".(11+$this->longitud_codigo_dependencia).")),-1) like '%".$dato."'";
