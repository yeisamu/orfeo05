...
{	
 case 'mssql':
	...
	$redondeo="datepart(dd, r.radi_fech_radi-".$db->conn->sysTimeStamp.")+floor(td.sgd_tpr_termino * 7/5)+(select count(*) from sgd_noh_nohabiles where NOH_FECHA between r.radi_fech_radi and ".$db->conn->sysTimeStamp.")";
