<?
	...
	cast(r.radi_nume_radi as varchar(15)) like '$data' and m.sgd_tpr_codigo=r.tdoc_codi";
...
break;
	case 'postgres':
		...
		$sqlr="select m.sgd_tpr_descrip from sgd_tpr_tpdcumento m,radicado r where
	cast(r.radi_nume_radi as varchar(15)) like '$data' and m.sgd_tpr_codigo=r.tdoc_codi";
		if(!isset($num_expediente)) $num_expediente="";
		if(!isset($edifi)) $edifi="";
		if(!isset($estan)) $estan="";
		if(!isset($entre)) $entre="";
