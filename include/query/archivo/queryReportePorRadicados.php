...
switch( $db->driver )
	...
	$queryUs  = "SELECT U.USUA_NOMB AS \"USUARIO\",
        ...
        {
        //$queryUs .= " AND ".$db->conn->substr."(cast(E.RADI_NUME_RADI as varchar(18)), -1, 1 ) =".$_POST['trad'];
 // MODIFICADO POR SKINA 
            $queryUs .= " AND cast(r.radi_nume_radi as varchar(15)) like '%".$_POST['trad']."' ";
	...
	$queryEDetalle .= " E.SGD_EXP_NUMERO AS EXPEDIENTE";
       ...
       // Usuario
        ...
        {
        $queryEDetalle .= " AND cast(r.radi_nume_radi as varchar(15)) like '%".$_GET['trad']."' ";
