...
$frad=date("Y-m-d h:i:s A");
	...
	case 'oracle':
	case 'oci8':
		$sql="insert into sgd_archivo_fondo (sgd_archivo_id,sgd_archivo_rad,sgd_archivo_orden,sgd_archivo_fechai,sgd_archivo_fechaf,sgd_archivo_year,
	...
	$sqlm="update sgd_archivo_fondo set sgd_archivo_orden='$orden',sgd_archivo_fechai='$fechaIni',sgd_archivo_fechaf='$fechaInif',sgd_archivo_year='$ano',
	...
	$query="select sgd_archivo_id from sgd_archivo_fondo where sgd_archivo_demandado like '%$demq%' and sgd_archivo_orden like '$orden' ";
	
	$sqlqm="select * from sgd_archivo_fondo where sgd_archivo_rad like '$rad'";
	...
	case 'postgres':
		...
		$query="select sgd_archivo_id from sgd_archivo_fondo where sgd_archivo_demandante like '%$demtq%' and sgd_archivo_demandado like '%$demq%' and sgd_archivo_orden like '$orden' ";
		$sqlqm="select * from sgd_archivo_fondo where sgd_archivo_rad like '$rad'";
	break;
	}
?>
