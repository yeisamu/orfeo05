<?
	...
	{  
	 case 'mssql':
	 $radi_nume_sal = "convert(varchar(11+".$longitud_codigo_dependencia."), RADI_NUME_SAL)";
	 $query = 'select  
		c.depe_nomb,
	...
	and '.$db->conn->substr.'('.$radi_nume_sal.',5,'.$longitud_codigo_dependencia.')=c.depe_codi
	and a.sgd_fenv_codigo=d.sgd_fenv_codigo';
	$order_isql = '  ORDER BY  '.$db->conn->substr.'('.$radi_nume_sal.', 5,'.$longitud_codigo_dependencia.'), a.SGD_RENV_FECH DESC,a.SGD_RENV_PLANILLA DESC';
