...
function pintarEstadistica($fila,$indice,$numColumna)
{
	...
	switch ($numColumna)
	{
		...
		case 2:
			...
			break;
		case 3:
			$salida=$fila['HOJAS_DIGITALIZADAS']+ $hojas_anexos;
			break;
...
$path_anex=substr($fila['HID_RADI_PATH'],0,10) ."docs/";	
...
switch ($numColumna)
{
	...
	case 1:
		if($fila['HID_RADI_PATH'] && $verImg)
                          $salida="<center><a href=\"{$ruta_raiz}bodega".$fila['HID_RADI_PATH']."\">".$fila['RADICADO']."</a></center>";// echo  $salida;
	
		else
			$salida="<center class=\"leidos\">{$fila['RADICADO']}</center>";
		break;
	case 2:  //   fila   codigo  anexo
	//	$salida="<center class=\"leidos\">".$fila['ANEX_CODIGO']."</center>";
                      $salida="<center><a href=\"{$ruta_raiz}bodega".$path_anex.$fila['ANEX_NOMBRE']."\">".$fila['ANEX_CODIGO']."</a></center>";
		break;
	case 3:
