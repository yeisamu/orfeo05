...
{
	$titulos=array("#","1#RADICADO","2#FECHA RADICACION","3#TIPO DE DOCUMENTO","4#ASUNTO","5#USUARIO ACTUAL","6#REMITENTE","7#DIAS RESTANTES");
}
else
{
    ...
    switch ($numColumna)
    {
        ...
        case 1:	
   		...
   		case 2:
        	...
        	{
        		$dependecia=isset($fila['HID_DEPE_USUA'])?$fila['HID_DEPE_USUA']:$_POST['dependencia_busq'];
        		$datosEnvioDetalle="tipoEstadistica=".$_POST['tipoEstadistica']."&amp;genDetalle=1&amp;usua_docs=".urlencode($fila['HID_USUA_DOC'])."&amp;dependencia_busq=".$dependecia."&amp;fecha_ini=".$_POST['fecha_ini']."&amp;fecha_fin=".$_POST['fecha_fin']."&amp;tipoRadicado=".$_POST['tipoRadicado']."&amp;tipoDocumento=".$_POST['tipoDocumento']."&amp;codUs=".$fila['HID_COD_USUARIO']."&amp;";
...
function pintarEstadisticaDetalle($fila,$indice,$numColumna){
			...
			switch ($numColumna){
					...
					case 2:
						...
						break;
					case 3:
						$salida="<span class=\"leidos\">".$fila['TIPO_DE_DOCUMENTO']."</span>";		
						break;
					case 5:
