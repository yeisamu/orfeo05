...
//$redondeo="datepart(dd,".$db->conn->sysTimeStamp." -r.radi_fech_radi)"; //sql server
...
//$a="'hola a'";
//$b="10";
//$redondeo= "CASE WHEN (select count(*) from hist_eventos h where r.radi_nume_radi=h.radi_nume_radi and h.sgd_ttr_codigo=13)>=1  THEN ".$b."  ELSE ".$a." END ";
$redondeo= "CASE WHEN (select count(*) from radicado where radi_depe_actu='999')=1  THEN ".$b."  ELSE ".$a." END ";
...
//$condicion2="and r.radi_nume_radi=h.radi_nume_radi";
$condicion2= "";
//$redondeo=$a;
//$redondeo=$a;
...
{	case 'mssql':
		{	$sSQL_1 = "select top 300 $radi_nume_radi AS RAD_ENTRADA, 
					...
					$tmp_substr($radi_nume_salida,1,11+".$longitud_codigo_dependencia.") AS RAD_SALIDA, 
			...
			$sSQL_2 = "SELECT top 300
				...
				WHERE  r.tdoc_codi=td.sgd_tpr_codigo 
					...
					AND b.depe_codi=d1.depe_codi 
					AND $tmp_substr($radi_nume_radi,11+".$longitud_codigo_dependencia.",1) = '2'
...
//					$fech_arch 				AS FEC_RAD_S, 
			$sSQL_1 = "select distinct($radi_nume_radi) 			AS RAD_ENTRADA,  
					...
					r.radi_usu_ante 			AS USU_ANT, 
                                        ...
                                        a.sgd_fech_impres                       AS FEC_IMPRE,
...
if(isset($_GET['genDetalle'])&& $_GET['denDetalle']=1){
		$titulos=array("#","1#RADICADODE ENTRADA","2#FECHA RADICACION DE ENTRADA","3#RADICACION DE SALIDA","4#FECHA DE RADICACION DE SALIDA","5#FECHA DE IMPRESION","6#FECHA DE ENVIO","7#TIPO","8#ASUNTO","8#DEPENDENCIA ACTUAL","9#USUARIO ACTUAL","10#USUARIO ANTERIOR","11#DIAS TRAMITE","12#TRAMITE TERMINADO");
	}else{ 		
		$titulos=array("#","1#FECHA DE RADICACION","2#RADICADOS","3#NUMERO DE RESPUESTAS");
	}
...
function pintarEstadisticaDetalle($fila,$indice,$numColumna){
			...
			switch ($numColumna){
					...
					case 13:
                                                 ...
                                                 if ($fila['DEP_ACTUAL']=="Dependencia de Salida") $archivo="si";
                                                  else $archivo="no";
