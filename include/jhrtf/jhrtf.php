...
/* Se establece la fuente que se utilizara para el texto. */
	...
	echo "<table border=1 width 80% cellpadding='0' cellspacing='5' class='borde_tab' >";
...
//			$this->validarLugar();
			...
			{     // Segun el tipo de remitente se graba en la tabla respectiva.
				...
				$birds2=$rs->fields['SGD_TPR_TERMINO'];
				...
				if($tip_doc==2)
				{	
					$codigo_us = $this->btt->grabar_usuario($doc_us1,$nombre_us1,$direccion_us1,$prim_apell_us1,$seg_apell_us1,$telefono_us1,$mail_us1,$codigo_depto,$codigo_muni,$tip_doc);
					$tipo_emp_us1=0;
