...
function anexoRadicado($radicado,$codigo) {
	...
	$q="select a.*,a.anex_fech_anex as FECHA_ANEX
		  from anexos a 
	...
	if 	(!$rs->EOF)
 		{
			 ...
			 $this->sgd_fech_doc=$rs->fields["FECHA_ANEX"];
			 ...
			 $this->radi_nume_salida=$rs->fields["RADI_NUME_SALIDA"];
                         ...
                         $this->sgd_srd_codigo=$rs->fields["SGD_SRD_CODIGO"];
                         $this->sgd_sbrd_codigo=$rs->fields["SGD_SBRD_CODIGO"];
