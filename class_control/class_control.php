...
function grabar_usuario($no_documento,$nombre_us1,$direccion_us1,$prim_apell_us1,$seg_apell_us1,$telefono_us1,$mail_nus1,$codep_us,$muni_codi,$tip_doc)
{
           if($tip_doc==2)
        {
...
//*******************************insertar  pensionados  o no****************


           if($tip_doc==3)
        {
		 $nextval=$this->cursor->nextId("sec_pen_pensionados");
