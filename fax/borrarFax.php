...
<tr>
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
		...
		$iBorrado = "cp /var/spool/hylafax/recvq/$faxBorrar"."tif /mnt/bodegas/prod/bodega/faxtmp/.";
		exec($iBorrado,$exec_output,$exec_return);
		//**  BORRANDO LA IMAGEN DEL REPOSITORIO DE FAX **/
		$iBorrado = "rm /var/spool/hylafax/recvq/$faxBorrar"."tif";
		exec($iBorrado,$exec_output,$exec_return);
		error_reporting(7);
		...
		{
		echo "El archivo $faxBorrar no pudo ser borrado";
		}
		?>
		</td>
		</tr>
