...
//$variables = "ent=$ent&radi=$radi&krd=$krd&".session_name()."=".trim(session_id())."&usua=$krd&contra=$drde&tipo=$tipo&ent=$ent&codigo=$codigo$datos_envio&numrad=$numrad";
        ...
        <!--                                <tr>
                                    <td  height="25" align="center" class="titulos4" colspan="2">Descripcion del documento
                                    </td>
                                </tr>-->
                                <tr>
                                    <td  colspan="2">
                                        <table border=1 width=100% class="borde_tab" >
                                            ...
                                            <div id="titulo" style="width: 100%;" align="center">Descripción del documento</div>
...
//Se agrega para traer fecha para el mensaje automatico
                                                    $sqlt_rad = "select TO_CHAR(RADI_FECH_RADI, 'YYYY-MM-DD') as FECHA from RADICADO where RADI_NUME_RADI = '$numrad'";
...
//    if (strlen(trim($radsalida))>0)    $swDischekRad = "disabled=true";
                                ...
                                <tr>
                                    <td>
                                        <table  width="90%" align="center" border="0" cellpadding="0" cellspacing="5" class="borde_tab" id="anexaExp" style="display:none">
                                            <tr>
                                                <td class="titulos2"  colspan="3" width="50%">Guardar en Expediente:</td>
                                                <td  valign="top">
<!--                                                    <table border="0"  align="center" class="titulos2">
                                                        <tr class="titulos2">-->
                                                            <?php
                                                            ...
                                                            if ($numFilas == 0) {
                                                                ...
                                                                $mostrarAlerta .= "<span align=\"center\">
                                                                <b>El radicado padre no está incluido  en un expediente.</b>
                                                                </span>
                                                                </td>";
...
<!--                                                        </tr>
                                ...
                                <tr valign="top" >
                                    <td  class='titulos2' valign="top" colspan="2">Descripción</td>
                                </tr>
                                <tr valign="top">
