...
require_once("$ruta_raiz/js/pestanas.js");
...
{	//Si el esta consultando la carpeta de documentos agendados entonces muestra el boton de sacar de la agenda
	if ($agendado)
	{	echo("<img name='principal_r5_c1'  src='$ruta_raiz/imagenes/internas/noAgendar.gif' alt='Menu para asignar fecha de agendado al radicado seleccionado' width='130' height='20' border='0' alt=''>");
     	echo ("<input name='Submit2' type='button' class='botones' value='Agendar' onClick='txNoAgendar();'>");
	}
	else
	{	echo("<img name='principal_r5_c1'  src='$ruta_raiz/imagenes/internas/agendar.gif' width='69' height='20' border='0' alt='Menu para asignar fecha de agendado al radicado seleccionado'> ");
?>
			<script language="javascript">
...
<!--		<td width="25" valign="bottom">
        ...
        <td width="63" valign="bottom">
        	...
        	<img src="<?=$ruta_raiz?>/imagenes/internas/moverA.gif" name="Image8" alt="Mover radicados entre carpetas" width="63" height="51" border="0"  ></a>		</td>
		<td width="64" valign="bottom">
			...
			<img src="<?=$ruta_raiz?>/imagenes/internas/reasignar.gif" name="Image9" alt="Reasignar radicados a otro usuario y/o dependencia" width="64" height="51" border="0"  ></a>		</td>
		<td width="66" valign="bottom">
			...
			<img src="<?=$ruta_raiz?>/imagenes/internas/informar.gif" name="Image10" alt="Informar radicado a algun usuario" width="66" height="51" border="0"></a>		</td>
		<td width="58" valign="bottom">
			...
			<img src="<?=$ruta_raiz?>/imagenes/internas/devolver.gif" name="Image11" width="58" alt="Devolver radicado a usuario anterior" height="51" border="0"></a>		</td>-->
	<?php
...
<!--		<td width="55" valign="bottom"><a href="#" onmouseout="MM_swapImgRestore()" onclick="seleccionBarra = 14;vistoBueno();" onmouseover="MM_swapImage('Image12','','<?=$ruta_raiz?>/imagenes/internas/overVobo.gif',1)"><img src="<?=$ruta_raiz?>/imagenes/internas/vobo.gif" name="Image12" width="55" height="51" alt="Solicitar Visto Bueno" border="0" /></a></td>-->
    <?
    		}
	}
	?>
...
<!--		<td width="61" valign="bottom"><a href="#" onmouseout="MM_swapImgRestore()" onclick="seleccionBarra = 61;changedepesel(61);" onmouseover="MM_swapImage('Image61','','<?=$ruta_raiz?>/imagenes/internas/overTRD.gif',1)"><img src="<?=$ruta_raiz?>/imagenes/internas/TRD.gif" name="Image61" alt="Asignar TRD Multiple a radicados seleccionados" width="61" height="51" border="0" /></a></td> -->
		<!--<td width="61" valign="bottom"><a href="radicacion/tipificar_documento_multiple.php?verrad=<?=$verrad?>" onmouseout="MM_swapImgRestore()" onclick="seleccionBarra = 61;changedepesel(61);" onmouseover="MM_swapImage('Image61','','<?=$ruta_raiz?>/imagenes/internas/overTRD.gif',1)"><img src="<?=$ruta_raiz?>/imagenes/internas/TRD.gif" name="Image61" width="61" height="51" border="0" /></a></td> -->
<!--		<td width="61" valign="bottom"><a href="expediente/insertarExpedienteMultiple.php?verrad=<?=$verrad?>" onmouseout="MM_swapImgRestore()" onclick="seleccionBarra = 62;changedepesel(62);" onmouseover="MM_swapImage('Image62','','<?=$ruta_raiz?>/imagenes/internas/overexpediente.gif',1)"><img src="<?=$ruta_raiz?>/imagenes/internas/expediente.gif" name="Image62" width="61" height="51" border="0" /></a></td>-->
<!--		<td width="61" valign="bottom"><a href="#" onmouseout="MM_swapImgRestore()" onclick="seleccionBarra = 62;changedepesel(62);" onmouseover="MM_swapImage('Image62','','<?=$ruta_raiz?>/imagenes/internas/overexpediente.gif',1)"><img src="<?=$ruta_raiz?>/imagenes/internas/expediente.gif" name="Image62" alt="Incluir en Expediente Multiple radicados" width="61" height="51" border="0"></a></td>-->
	<?php
...
<!--			<a href="#" onMouseOut="MM_swapImgRestore()" onClick="seleccionBarra = 13;changedepesel(13);" onMouseOver="MM_swapImage('Image13','','<?=$ruta_raiz?>/imagenes/internas/overArchivar.gif',1)">
			<img src="<?=$ruta_raiz?>/imagenes/internas/archivar.gif" name="Image13" width="61" alt="Archivar / Finalizar tramite radicado seleccionado" height="51" border="0"></a>		</td>-->
		<?php
			}
...
<!--		<td width="61" valign="bottom"><a href="#" onmouseout="MM_swapImgRestore()" onclick="seleccionBarra = 14;changedepesel(16);" onmouseover="MM_swapImage('Image14','','<?=$ruta_raiz?>/imagenes/internas/overNRR.gif',1)"><img src="<?=$ruta_raiz?>/imagenes/internas/NRR.gif" name="Image14" width="61" alt="Archivar radicado que no requiere respuesta alguna." height="51" border="0" /></a></td>-->
		<?php
		}
	}
?>
		...
		<? if ($controlAgenda==1){ ?>
			...
			<tr>
				...
				<td width="60%" class="titulos2">
					<a href='<?=$ruta_raiz?>/cuerpo.php?<?=session_name()."=".trim(session_id()).$encabezado."7&orderTipo=DESC&orderNo=10"; ?>' aria-label='Ordenar Por radicados Leidos' title='Ordenar Por radicados Leidos' alt='Ordenar Por radicados Leidos'>
					<span class='leidos'>Le&iacute;dos</span></a><?=$img7 ?>&nbsp;
					<a href='<?=$ruta_raiz?>/cuerpo.php?<?=session_name()."=".trim(session_id()).$encabezado."8&orderTipo=ASC&orderNo=10" ?>' title='Ordenar Por radicados no Le&iacute;dos' alt='Ordenar Por radicados no Le&iacute;dos' aria-label='Ordenar Por radicados no Le&acute;dos' class="tparr">
