...
<html>
    <head>
        ...
        <script>
            ...
            function generar_envio()
            {
                ...
                {
                    alert('Porfavor verifique el número de guia');
                    return false;
                }
    ...
    <body>
        ...
        ?>
    <center>
            <div id="titulo" style="width: 85%;" align="center">Envío de documentos</div>
    </center>
...
//by skina; numero de guia y observaciones
                            ...
                            <td colspan="7" class="listado1">
                                <table class="borde_tab" width="100%" border="0">
                                    <tr>
                                        <td valign="top" >
                                    <font><center>
                                        <input name="reg_envio" type="submit" value="Generar Registro de Envío de Documento" id="GENERAR REGISTRO DE ENVIO DE DOCUMENTO" onClick="return generar_envio();" class="botones_largo">
            ...
            //by skina 
            //include "../envios/listaEnvio.php";
            echo "<center><b><span>Registro de Envio Generado</span> </b></center><br><br>";
