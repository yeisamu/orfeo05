...
function spiffyCalManager() {
	...
	// *** HOLIDAYS ***************************
	//by skina generico 
	this.Holidays = new Array("Ene-1","May-1","Jul-20","Ago-7","Dic-8","Dic-25");
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, intBtnMode) {
	...
	//		strHold+=this.varName+'.show();return false;">';
			...
			strHold+='<img align="absmiddle" alt="Boton para desplegar el calendario" border="0" name="' + this.btnName + '" src="' + strBtnImg +'" width="'+ strBtnW +'" height="'+ strBtnH +'"></a>';
		}
