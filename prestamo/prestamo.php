        ...
        <center>
            <table border=1 width="100%" cellpadding=0 cellspacing=2 class='borde_tab'>	  
                ...
                <tr id="b0" style="display:<?= $tipoBusqueda[$opcionMenu][0]; ?>">
                    ...
                    <td class="listado2"><input type="text" id="s_RADI_NUME_RADI" name="s_RADI_NUME_RADI" maxlength="15" value="<?= $flds_RADI_NUME_RADI; ?>" size="25" class="tex_area" title="Campo para ingresar el número o parte del número del radicado"></td>
                </tr>	  
