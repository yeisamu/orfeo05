...
include_once("$ruta_raiz/include/jh_class/funciones_sgd.php");
...
{	case '0':
	{	//Si incluy� alguna cadena a buscar
		...
		$sql = "SELECT IDENTIFICADOR_EMPRESA AS ID,nombre_de_la_empresa AS NOMBRE,
				...
				ORDER BY ID_CONT,IDPAIS,codigo_del_departamento asc,codigo_del_municipio asc, nombre_de_la_empresa asc limit 1000";
	}break;
	case '1':
	{	//Si incluy� alguna cadena a buscar
