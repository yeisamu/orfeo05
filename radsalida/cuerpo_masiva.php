            ...
            <table border=0 width='100%' align='center' >
                <tr>
                    <td height="20"> 
                         ...
                         */
                        include_once "$ruta_raiz/include/query/radsalida/queryCuerpoMasiva.php";
                                ...
                                <td height="37" width="33%"> 
                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr> 
                                            <td>
                                                <form name=formDep>
                                                    <select name="dep_sel" class="select" id="dep_sel"  onChange = "cambioDependecia(this.value)" title="Listado de todas las dependencias existentes" >
                        ...
                        <table border=0 cellspacing="5"  WIDTH=100% class='borde_tab' align='center'>
                            <tr align="center"> 
                                <td> <?
                                    ...
                                    $paginas = ($numerot / 20);
                                    ?><span class='leidos'> Páginas</span> <?
