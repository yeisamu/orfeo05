 ...
 */ 
 ...
 /* Variables */
	...
	var $bodyTagInit = '<w:body>'; 	//Etiqueta Inicial cuerpo del documento
	var $bodyTagEnd = '</w:body>';		//Etiqueta Final cuerpo del documento
	var $endDocTags = '</w:body></w:document>';	//Etiquetas de Finalización de Documento ODT
