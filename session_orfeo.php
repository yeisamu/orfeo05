...
if ( !$validacionUsuario )
{
	...
	//by skina
	if(!$imagenes) $imagenes = "/imagenes1/";
...
?>
			<script language="JavaScript" type="text/JavaScript">
                                        alert("Falla verificación datos del usuario <?=$krd?> con la base de datos, \n Intente Nuevamente o verifique el estado de su usuario  ");
                                </script>
  			<!--<H4 align="center" >
                        <strong>FALLA VERIFICACI&Oacute;N CON BASE DE DATOS<BR>
                        <?=$mensajeError?><BR>INTENTE DE NUEVO</strong></H4>-->
<?php
		}
		else
		{
?>
  			<H4 align="center">
                        <strong>FALLA VERIFICACI&Oacute;N LDAP<BR>
                        <?=$mensajeError?><BR>INTENTE DE NUEVO</strong></H4>
<?php
		}
	}
