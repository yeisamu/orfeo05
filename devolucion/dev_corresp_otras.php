        ...
        if (!$devolver_rad or $motivo_devol == 0) {
            ...
            <center>
                <table width="55%" class="borde_tab" border="2" cellpadding="5">
                    <tr>
                        <div id="titulo" style="width: 55%;" align="center">Devolución de documentos</div>
                    </tr>
                    <TR>
                        <TD width="125" height="21"  class='titulos2'>Tipo de Devolución<br></TD>
				...
				WHERE SGD_DEVE_CODIGO < 99
				 order by SGD_DEVE_CODIGO";
                    ...
                    <TR>
                        ...
                        <input type=SUBMIT name='devolver_rad'  value = 'Confirmar devolución' class='botones_largo' ></center></td>
                    </tr>
                </TABLE>
            </center>
            <?php
