 ...
 */
$tituloE[1] = "1 - CONSULTA DE RADICADOS POR USUARIO";
$tituloE[2] = "2 - ESTADISTICAS POR MEDIO DE RECEPCION";
$tituloE[3] = "3 - ESTADISTICAS DE MEDIO ENVIO FINAL DE DOCUMENTOS";
//$tituloE[4] = "4 - ESTADISTICAS DE DIGITALIZACION DE DOCUMENTOS";
$tituloE[5] = "5 - RADICADOS DE ENTRADA RECIBIDOS DEL AREA DE CORRESPONDENCIA";
$tituloE[6] = "6 - RADICADOS ACTUALES EN LA DEPENDENCIA";
//$tituloE[7] = "7 - ESTADISTICAS DE NUMERO DE DOCUMENTOS ENVIADOS";	  	  
//$tituloE[8] = "8 - REPORTE DE VENCIMIENTOS";	  	  
$tituloE[9] = "9 - REPORTE PROCESO RADICADOS DE ENTRADA";
$tituloE[10] = "10 - REPORTE REASIGNACION RADICADOS";
...
$tituloE[14] = "14 - REPORTE DE RADICADOS ASIGNADOS DETALLADOS (CARPETAS PERSONALES)";
$tituloE[15] = "15 - ESTADISTICAS DE DIGITALIZACION (ANEXOS)";
$tituloE[16] = "16 - ESTADISTICAS DE  TRAMITES TERMINADOS";
$tituloE[17] = "17 - ESTADISTICA POR RADICADOS Y SUS RESPUESTAS";
...
$subtituloE[17] = "ORFEO - Fecha: " . date("Y/m/d H:i:s") . "\n Parametro    s de Fecha: Entre $fecha_ini y $fecha_fin";


$helpE[1] = "Este reporte genera la cantidad de radicados creados por usuario. Se puede discriminar por tipo de radicaci&oacute;n. ";
...
$helpE[14] = "Muestra el total de radicados que tiene un usuario detallados por cada carpeta";
...
$helpE[16] = "Reporte  con respecto a los  días de tramite y finalización de éste";
        ...
        <form name="formulario"  method=post action='./vistaFormConsulta.php?<?= session_name() . "=" . trim(session_id()) . "&krd=$krd&fechah=$fechah" ?>'>
            <center>
                ...
                <table width="95%"  border="1" cellpadding="0" cellspacing="5" class="borde_tab">
                    ...
                    <tr>
                        <td width="30%" class="titulos2"><label for="tipoEstadistica">Tipo de Consulta / Estadistica</label></td>
                        <td class="listado2" align="left">
                            <select id="tipoEstadistica" name=tipoEstadistica  aria-label='Listado de tipos de estadisticas del aplicativo' class="select" onChange="formulario.submit();">
                                <?
                    ...
                    <tr>
                        ...
                        <td class="listado2">
                            <select id="dependencia_busq" name=dependencia_busq  aria-label='Listado de dependecias disponibles para la generación de estadísticas' class="select"  onChange="formulario.submit();">
                                <?
...
//echo " tipo $tipoEstadistica ";
                    ...
                    if ($tipoEstadistica == 1 or $tipoEstadistica == 2 or $tipoEstadistica == 3 or
                        ...
                        <tr id="cUsuario">
                            ...
                            <td class="listado2">
                                <select id="codus" name="codus"  aria-label='Listado de usuarios disponibles para genera la estadistica seleccionada' class="select"  onChange="formulario.submit();">
                    ...
                    if ($tipoEstadistica == 1 or $tipoEstadistica == 2 or $tipoEstadistica == 4 or $tipoEstadistica == 6 or $tipoEstadistica == 11 or $tipoEstadistica == 12 or $tipoEstadistica == 15 or $tipoEstadistica == 16 or $tipoEstadistica == 17) {
                        ...
                        <tr>
                            ...
                            <td class="listado2">
                                ...
                                print $rs->GetMenu2($nmenu, $default_str, $blank1stItem = "$valor:$itemBlanco", false, 0, "class=select id='nmenu' aria-label='Listado de tipos de radicados para incluir en la estadistica'");
                                ?>&nbsp;</td>
                        </tr>
                        <?
                    }
                    if ($tipoEstadistica == 1 or $tipoEstadistica == 6 or $tipoEstadistica == 10 or
                        ...
                        <tr>
                            ...
                            <td class="listado2">
                                <select id="tipoDocumento" name=tipoDocumento  class="select" aria-label='Listado con los tipos documentales para seleccionar en la estadistica' >
                                    <?
                    ...
                    if ($tipoEstadistica == 1 or $tipoEstadistica == 2 or $tipoEstadistica == 3 or
                            ...
                            $tipoEstadistica == 11 or $tipoEstadistica == 12 or $tipoEstadistica == 15 or $tipoEstadistica == 16 or $tipoEstadistica == 17) {
                        ?>  
                        <tr>
                            <td width="30%" class="titulos2"><label>Fecha inicial (año/mes/dia)</label> </td>
                            <td class="listado2">
                                <script language="javascript">
                        ...
                        <tr>
                            <td width="30%" class="titulos2"><label>Fecha final (año/mes/dia) </label></td>
                            <td class="listado2">
                                <script language="javascript">
                    ...
                    <center>
                        <input name="Submit" type="submit" class="botones" value="Limpiar" aria-label='Restablecer valores del formulario a los por defecto'> 
...
//Modificado idrd para enviar documento del usuario
        $datosaenviar = "fechaf=$fechaf&tipoEstadistica=$tipoEstadistica&codus=$codus&krd=$krd&dependencia_busq=$dependencia_busq&ruta_raiz=$ruta_raiz&fecha_ini=$fecha_ini&fecha_fin=$fecha_fin&tipoRadicado=$tipoRadicado&tipoDocumento=$tipoDocumento&usua_doc=$usuadocs";
...
//$db->conn->debug = true;
            ...
            $paginas = ($numerot / 20);
            ?><span class='vinculos'>Páginas </span> <?
