...
<table width="100%"  border="0" cellpadding="0" cellspacing="5" class="borde_tab">
  <tr>
    ...
    <td colspan="2" class="titulos4">POR RADICADOS </td>
  </tr>
  <tr>
...
if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or 
	...
	$tipoEstadistica==7 or $tipoEstadistica==11 or $tipoEstadistica==12 or $tipoEstadistica==10)
{

//echo "permiso $usua_perm_estadistica";
...
<tr>
  ...
  if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or 
  		...
  		$tipoEstadistica==11 or $tipoEstadistica==12)
  {
  ?>  
  <tr>
