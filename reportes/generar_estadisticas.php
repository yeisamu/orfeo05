...
<BODY>
    ...
    <form name=formboton  method=post  action='generar_estadisticas.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fecha_h=$fechah&fecha_busq=$fecha_busq&fecha_busq2=$fecha_busq2" ?>'>
        ...
        <TABLE width="650px" class="borde_tab" border="2" align="center">
            <!--DWLayoutTable-->
            <tr>
            <div id="titulo" style="width: 650px;" align="center">Generación Listados de Documentos <br> Devueltos por Agencia de Correo</div>
            </tr>
            <TR>
...
//Se limita la consulta al substring del numero de radicado de salida 27092005
            ...
            /* 	by skina dejamos TODOS los tipos de envio
            ...
            $campos_vista = array("Forma de Envío", "Dependencia", "Radicado", "Destinatario", "Dirección", "Municipio", "Departamento", "Fecha de Envío", "Fecha Dev", "Motivo Devolucion", "Recibido");
        ...
        . "<strong>"
        . "<h3>"
                . "<a href='$arpdf_tmp' target='" . date("dmYh") . time("his") . "' class='vinculos' aria-label='Generar informe en archivo pdf'>Abrir Archivo Pdf</a>"
                . "</h3>"
                . "</strong>"
                . "</div>";
    }
