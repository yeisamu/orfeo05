...
//    var $last = '<code>>|</code>';
    ...
    function RenderGrid() {
        ...
        $htmlContent = rs2html($this->db, $this->rs, $this->gridAttributes, $this->gridHeader, $this->htmlSpecialChars, true, $this->toRefVars, $this->orderTipo, $this->ordenActual, $this->rutaRaiz, $this->checkAll, $this->checkTitulo, $this->descCarpetasGen, $this->descCarpetasPer);
        $xsql = serialize($this->sql);
        $_SESSION['xsql'] = $xsql;
        $_SESSION['rutaRaiz'] = $rutaRaiz;
        echo "<a style='border:0px' href='$rutaRaiz/adodb/adodb-doc.inc.php' target='_blank'><img data-toggle='tooltip' data-placement='top' title='Exportar contenido del listado en formato \".doc\"' src='$rutaRaiz/adodb/compfile.png' width='40' heigth='40' border='0' alt='Exportar contenido del listado en formato word'></a>";
        echo "<a href='$rutaRaiz/adodb/adodb-xls.inc.php' target='_blank'><img data-toggle='tooltip' data-placement='top' title='Exportar contenido del listado como hoja de calculo' src='$rutaRaiz/adodb/spreadsheet.png' width='40' heigth='40' alt='Exportar contenido del listado en formato para excel' border='0'></a>";
        $s = ob_get_contents();
        ob_end_clean();
        return $s;
    }
