...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            ...
            emptyError: "{file} está vacio, por favor seleccione otro archivo.",
            noFilesError: "No hay archivos para subir.",
            onLeave: "Los archivos están siendo subidos, si usted cierra o cancela la operación estos serán cancelados."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
    ...
    _maybeParseAndSendUploadError: function(id, fileName, response, xhr) {
        ...
        if (!response.success){
            if (xhr && xhr.status !== 200 && !response.error) {
                ...
                var errorReason = response.error ? response.error : "Subida de archivos fallida, razón desconocida";
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: 'Anexar Archivos',
            cancelButton: 'Cancelar',
            retryButton: 'Re - intentar',
