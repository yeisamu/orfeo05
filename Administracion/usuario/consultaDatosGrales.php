...
//	$db->conn->debug = false;
    ...
    <center>
        ...
        <!--    <td colspan="2" class="titulos4">
                ...
                <div id="titulo" style="width: 93%; " align="center" >Administración de usuarios y perfiles
                    <br>
                    Consulta de usuario
                </div>
                </tr>
...
?>
                    ...
                    <td class="listado2" height="26"><div align="left" class="titulo2"><label for="dep_sel">Dependencia</label></div></td>
...
?>
            ...
            <table border=1 width=93% class=t_bordeGris>
                ...
                <td class="listado2" height="26"><label for="cedula">Nro Cedula</label><input readonly="yes" type=text name=cedula id=cedula value='<?= $cedula ?>' size=15 maxlenght="14" > </td>
                <td class="listado2" height="26"><label for="usuLogin">Usuario</label><input readonly="yes" type=text name=usuLogin id=usuLogin value='<?= $usuLogin ?>' size=20 maxlenght=15></td>
                </tr>
            </table>

            <table border=1 width=93% class=t_bordeGris>
                <tr class=timparr>
                    <td class="listado2" height="26"><label for="nombre">Nombres y Apellidos</label><input readonly="yes" type=text name=nombre id=nombre value='<?= $nombre ?>' size=50 maxlenght=45> </td>
            ...
            <table border=1 width=93% class=t_bordeGris>
                <tr class=timparr>
                    <td class="listado2" height="26"><label for="ubicacion">Ubicacion AT</label><input readonly="yes" type=text name=ubicacion id=ubicacion value='<?= $ubicacion ?>' size=20></td>
                    <td class="listado2" height="26"><label for="piso">Piso</label><input readonly="yes" type=text name=piso id=piso value='<?= $piso ?>' size=10 ></td>
                    <td class="listado2" height="26"><label for="extension">Extension</label><input readonly="yes" type=text name=extension id=extension value='<?= $extension ?>' size=10></td>
                </tr>
            </table>
            <table border=1 width=93% class=t_bordeGris>
                <tr class=timparr>
                    <td width="54%" height="26" class="listado2"><label for="email">Mail</label>
