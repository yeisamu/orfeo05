...
<!--                                <td colspan="2" class="titulos4">
                            ...
                            <div id="titulo" style="width: 80%;" align="center" >Administración de usuarios y perfiles
                                <br>
                                <?= $tPermisos ?>
                            </div>
                </tr>
                ...
                ?>
                <tr>
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="digitaliza" value="$digitaliza" <?
                        if ($digitaliza)
                            echo "checked";
                        else
                            echo "";
                    ...
                    <td width="40%" height="26" class="listado2"> Tablas de Retenci&oacute;n Documental
                        ...
                        $contador = 0;
                        while ($contador <= 2) {
                            echo "<input disabled name='tablas' type='radio' value=$contador";
                            if ($tablas == $contador)
                                echo "checked";
                            else
                                echo "";
                        ...
                        ?></tr>
                <tr>
                    <td width="40%" height="26" class="listado2"> <input disabled name="modificaciones" type="checkbox" value="$modificaciones" <?
                        if ($modificaciones)
                            echo "checked";
                        else
                            echo "";
                        ?>>
                        Modificaciones</td>
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="masiva" value="$masiva" <?
                        if ($masiva)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    ...
                    <td width="40%" height="26" class="listado2"><input disabled type="checkbox" name="prestamo" value="$prestamo" <?
                        if ($prestamo)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="s_anulaciones" value="$s_anulaciones" <?
                        if ($s_anulaciones)
                            echo "checked";
                        else
                            echo "";
                    ...
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="anulaciones" value="$anulaciones" <?
                        if ($anulaciones)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td width="40%" height="26" class="listado2"> <!--input disabled type="checkbox" name="adm_archivo" value="$adm_archivo" <?
                        if ($adm_archivo)
                            echo "checked";
                        else
                            echo "";
...
// Modificado por Fabian Mauricio Losada
                    ...
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="dev_correo" value="$dev_correo" <?
                        if ($dev_correo)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="adm_sistema" value="$adm_sistema" <?
                        if ($adm_sistema)
                            echo "checked";
                        else
                            echo "";
                    ...
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="env_correo" value="$env_correo" <?
                        if ($env_correo)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="reasigna" value="$reasigna" <?
                        if ($reasigna)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="usua_activo" value="$usua_activo" <?
                        if ($usua_activo == 1)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td width="40%" height="26" class="listado2"> <input disabled type="checkbox" name="usua_nuevoM" value="$usua_nuevoM" <?
                        if ($usua_nuevoM == '0')
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td height='26' width='40%' class='listado2'>
                        <input disabled type="checkbox" name="permArchivar" value="$permArchivar" <?
                        if ($permArchivar)
                            echo "checked";
                        else
                            echo "";
                    ...
                    <td height='26' width='40%' class='listado2'>
                        <input disabled type="checkbox" name="usua_publico" value="$usua_publico" <?
                        if ($usua_publico)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    ...
                    <td width="40%" height="26" class="listado2">
                        <input disabled type="checkbox" name="notifica" value="$notifica" <?
                        if ($notifica)
                            echo "checked";
                        else
                            echo "";
...
<!--                <td colspan="2" class="titulos4" align="center">
            ...
            <div id="titulo" style="width: 80%;" align="center" >Permisos tipos de radicados</div>
        </tr>
        <?php
    ...
    <table border=0 width=80% class=t_bordeGris>
    ...
    <td height="30" colspan="2" class="listado1">
    <center>
        <a class="botones" name="Submit4" href='../formAdministracion.php?<?= session_name() . "=" . session_id() . "&$encabezado" ?>'>&nbsp;&nbsp;&nbsp;&nbsp;Cancelar&nbsp;&nbsp;&nbsp;&nbsp;</a></center>
