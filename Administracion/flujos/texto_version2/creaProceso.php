...
<table width="93%"  border="1" align="center">
	...
	<center>
	<p><B><span class=etexto>ADMINISTRACIÓN DE FLUJOS</span></B> </p>
	<p><B><span class=etexto> Creación de Proceso </span></B> </p></center>
	</td>
	</tr>
</table>
<table border=1 width=93% class=t_bordeGris align="center">
	<tr class=timparr>
			<td class="titulos2" height="26" width="25%" colspan="-1"><label for="nombreProceso">Nombre Proceso</label></td>
			<td class="listado2" height="1" width="75%" colspan="3">
			<input id="nombreProceso" type=text name=nombreProceso value='<?=$nombreProceso?>' maxlength="100" size="90" title="Campo para ingresar el nombre del proceso a crear">
			</td>
	</tr>
	
	<tr align="center">
		<td width="25%" class="titulos2"><label for="codserie">SERIE</label></td>
		<td width="25%" height="35" class="listado2">
			<?php
				...
				print $rsD->GetMenu2("codserie", $codserie, "0:-- Seleccione --", false,"","onChange='submit()' class='select' id='codserie' title='Listado de todos los procesos existentes'" );
			 ?>
				</td>
		 	
				<td width="25%" class="titulos2"><label for="tsub">SUBSERIE</label></td>
				<td width="25%" height="35" class="listado2">
				<?
					...
					include "$ruta_raiz/include/tx/ComentarioTx.php";
					print $rsSub->GetMenu2("tsub", $tsub, "0:-- Seleccione --", false,""," class='select' id='tsub' title='Listado de todas las subseries existentes'" );
