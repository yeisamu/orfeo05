...
<tr class=timparr>
	...
	<td width="25%" class="titulos2" height="26">Seleccione el Código</td>
	<td width="72%" class="listado2" height="1">
		...
		<tr>
			...
			<td width="10%" align="center"><input type="radio" id="cuatro" value="4" name="grpRad" onclick="ver_datos(this.value)" title="Al activar esta casilla se muestra la información del tipo de radicado 4 si existe"></td>
