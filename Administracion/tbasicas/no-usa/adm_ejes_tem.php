...
<tr bordercolor="#FFFFFF">
	<td colspan="3" height="40" align="center" class="titulos4" valign="middle"><b><span class=etexto>ADMINISTRADOR DE EJES TEMATICOS</span></b></td>
</tr>
<tr bordercolor="#FFFFFF">
	<td width="3%" align="center" class="titulos2"><b>1.</b></td>
	<td width="25%" align="left" class="titulos2"><b>&nbsp;<label for="slc_ppal">Seleccione eje tem&aacute;tico :</label></b></td>
...
<tr bordercolor="#FFFFFF">
	...
	<td align="left" class="titulos2"><b>&nbsp;<label for="slc_cmb2">Seleccione estado</label></b></td>
...
<tr bordercolor="#FFFFFF">
	...
	<td align="left" class="titulos2"><b>&nbsp;<label for="txtId">Código de eje tematico</label></b></td>
...
<tr bordercolor="#FFFFFF">
	...
	<td width="20%"  class="listado2">
		...
		<input name="btn_accion" type="button" class="botones" id="btn_accion" value="Listado" onClick="ver_listado();" aria-label="Listar las tablas sencillas existentes em una nueva ventana">
		</center></span>
	</td>
	<td width="20%" class="listado2">
	...
	<td width="20%" class="listado2">
		<span class="e_texto1"><center>
		<input name="btn_accion" type="submit" class="botones" id="btn_accion" value="Modificar" onClick="document.form1.hdBandera.value='M'; return ValidarInformacion();" aria-label="Guardar cambios de la tabla sencilla seleccionada">
		</center></span>
	</td>
	<td width="20%" class="listado2">
		<span class="e_texto1"><center>
		<input name="btn_accion" type="submit" class="botones" id="btn_accion" value="Eliminar" onClick="document.form1.hdBandera.value='E'; return ValidarInformacion();" aria-label="Borrar tabla sencilla seleccionada">
		</center></span>
	</td>
	<td width="10%" class="listado2">&nbsp;</td>
</tr>
