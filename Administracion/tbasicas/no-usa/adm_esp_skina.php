...
{	$msg = '<tr bordercolor="#FFFFFF">
	...
	{	case 1:	//NO CONECCION A BD
		...
		case 3:	//ACUTALIZACION REALIZADA
				$msg .= "Información actualizada!!";break;
		...
		case 5:	//IMPOSIBILIDAD DE ELIMINAR ESP, TIENE HISTORIAL, EST� LIGADO CON DIRECCIONES
				$msg .= "No se puede eliminar Entidad, se encuentra ligado a direcciones contactos.";break;
	}
	$msg .= '</td></tr>';
}
?>
...
<tr bordercolor = "#FFFFFF">
	...
	<td width="20%" align="left" class="titulos2">Seleccione Cliente</td>
	<td class="listado2">&nbsp;
	<?php
