...
<? if (isset($vcltav)) echo arrayToJsArray($vcltav, 'vp'); ?>
//-->
</script>
<head>
...
<table width="75%" align="center" border="1" cellspacing="0" class="tablas">
	<tr bordercolor="#FFFFFF">
    	...
    	<td align="left" class="titulos2"><label for="id_fenv">Forma del envío</label></td>
...
?>
	...
	<tr bordercolor="#FFFFFF">
	    ...
	    <td width="26%" align="left" class="titulos2"><label for="slc_TipoTar">Localización del Envío</label> </td>
	    <td colspan="4" class="listado2">
	    	<select name="slc_TipoTar" class="select" id="slc_TipoTar" onChange="if (id_fenv.value == 0) {alert ('Seleccione Forma de Envio'); slc_TipoTar.value=0;} else this.form.submit()" title="Tipos de destino del envío">
...
<?		// Listamos las tarifas.
		...
		else echo "<select name='id_clta' id='id_clta' class='select' title='Listado de envíos de acuerdo a la forma de envío seleccionada'></select>";
?>
		</td>
	</tr>
	<tr bordercolor="#FFFFFF">
	    <td width="5%" rowspan="5" align="center" valign="middle" class="titulos2">4.</td>
	    <td width="26%" class="titulos2"><label for="txt_idTar">Código</label></td>
	    <td colspan="4" align="center" class="listado2">
			<input name="txt_idTar" id="txt_idTar" type="text" size="5" maxlength="5" title="Código de la forma de envío">
	    </td>
	</tr>
	<tr bordercolor="#FFFFFF">
	    <td width="26%" rowspan="2" class="titulos2">Peso</td>
	    <td width="16%" align="center" class="titulos2"> <label for="txt_lim1">Límite Inferior</label></td>
	    <td width="16%" align="center" class="titulos2"><label for="txt_lim2">Límite Superior</label> </td>
	    <td colspan="2" align="center" class="titulos2"><label for="txt_desc">Descripción</label></td>
	</tr>
	<tr bordercolor="#FFFFFF">
	...
	<tr bordercolor="#FFFFFF">
		<td width="26%" rowspan="2" class="titulos2">Valor Envío</td>
...
<tr class="cajaBotonesMedio">
	...
	<td width="20%" class="listado1">
		<span class="e_texto1"><center>
		<input name="btn_accion" type="submit" class="botones" id="btn_accion" value="Modificar" onClick="document.form1.hdBandera.value='M'; return validarinfo(this.form);" aria-label="Guardar cambios de la tarifa seleccionada">
		</center></span>	</td>
	<td width="20%" class="listado1">
		<span class="e_texto1"><center>
