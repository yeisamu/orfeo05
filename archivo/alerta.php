...
<!--    <tr>
    ...
    if($codserie!=0) $wheresub=" and m.sgd_srd_codigo = '$codserie' and su.sgd_srd_codigo = '$codserie' ";
    else $wheresub="";
    
    $querySub = $querySub.$wheresub." order by detalle";
    
    $rsSub=$db->conn->query($querySub);
    print $rsSub->GetMenu2("tsub", $tsub, "0:-- TODAS --", false,"","onChange='submit()' class='selectReducido' id='tsub' title='Listado de todas las subseries existentes, se actualiza al seleccionar una serie'" );
