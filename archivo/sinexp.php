...
<TD class=titulos2 colspan="4">
	...
	<td class="listado2"><input type="text" align="absmiddle" value="<?=$rad?>" id="rad" name="rad" title="Buscar por número de radicado"> </td>
	</tr>
	<tr>
...
?>
	...
	<tr><td class="titulos2" align="right"><label for="fechaInif">Fecha Radicado Final</label></td>
	<td class="listado2">
	<script language="javascript">
	...
	<tr>
         <td class="listado1" align="center" colspan="2">
            <center>
