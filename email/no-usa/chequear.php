<?
/************************************************************************
# PROYECTO: Orfeo   MODULO: Email - chequear.php     FECHA: Octubre 2012*
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
#                                                                       *
#                                                                       *
#                                                                       *
...
include_once "$ruta_taiz/include/db/ConnectionHandler.php";
...
if($faxPath) {
    $iSql= " SELECT sgd_rfax_fax, usua_login, sgd_rfax_fechradi
                    ...
                    WHERE sgd_rfax_fax='$faxPath' AND usua_login='$krd'
                    ";
...
* @fecha 2005-02
*/
  include "$rtua_raiz/radicacion/formRadPrevia.php";
?>
</div>
</form>
